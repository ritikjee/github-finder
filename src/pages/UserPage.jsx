...
function UserPage() {
    const {getUser,user,loading,repos,getUsersRepos}=useContext(GithubContext)
    const param=useParams()

    useEffect(()=>{
        getUser(param.login)
        getUsersRepos(param.login)
            ...
            <div className="col-span-2">
              <div className="mb-6">
                ...
                <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                  {location&&(
                    <div className="stat">
                      <div className="stat-title title-md">
                        Location
                      </div>
                  ...
                  {twitter_username&&(
                    <div className="stat">
                      ...
                      <div className="text-lg stat-value"><a href={`https://${twitter_username}`} target="_blank" rel="noreferrer">{twitter_username}</a></div>
                    </div>
                  )}
                </div>
              </div>
